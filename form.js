...
new _vue2.default({
    ...
    render: function render(createElement) {
        return createElement(_form2.default, {
            attrs: {
...
},{"./form.vue":2,"vue":6}],2:[function(require,module,exports){
;(function(){
'use strict';
...
var _kaleidoscope = require('./kaleidoscope.js');
...
exports.default = {
    ...
    created: function created() {
        ...
        this.kaleidoscope = new _kaleidoscope2.default('kaleidoscope', this.root.offsetWidth, this.root.offsetHeight, this.fullscreen, this.points, this.image, this.rotateSpeed);

        window.onresize = function () {
            return _this.kaleidoscope.setDimensions(_this.root.offsetWidth, _this.root.offsetHeight);
        };
    },
    ...
    watch: {
        ...
        rotateSpeed: function rotateSpeed() {
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"form-container",class:{"form-hidden": _vm.formHidden}},[_c('div',{staticClass:"show-hide",on:{"click":_vm.toggleForm}},[_vm._v(_vm._s(_vm.formHidden ? '▲' : '▼'))]),_vm._v(" "),_c('form',[_c('div',[_c('header'),_vm._v(" "),_c('div',[_c('label',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.fullscreen),expression:"fullscreen"}],attrs:{"id":"fullscreen","type":"checkbox"},domProps:{"checked":Array.isArray(_vm.fullscreen)?_vm._i(_vm.fullscreen,null)>-1:(_vm.fullscreen)},on:{"__c":function($event){var $$a=_vm.fullscreen,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$c){$$i<0&&(_vm.fullscreen=$$a.concat($$v))}else{$$i>-1&&(_vm.fullscreen=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.fullscreen=$$c}}}}),_vm._v("\n                    Fullscreen\n                ")])])]),_vm._v(" "),_c('div',[_c('header',[_vm._v("Image")]),_vm._v(" "),_c('div',_vm._l((_vm.images),function(path,label){return _c('label',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.image),expression:"image"}],attrs:{"type":"radio"},domProps:{"value":path,"checked":_vm.image === path,"checked":_vm._q(_vm.image,path)},on:{"__c":function($event){_vm.image=path}}}),_vm._v("\n                    "+_vm._s(label)+"\n                ")])}))]),_vm._v(" "),_c('div',[_c('header',[_vm._v("Points")]),_vm._v(" "),_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.points),expression:"points"}],attrs:{"id":"points","type":"range","min":"0","max":"20"},domProps:{"value":(_vm.points)},on:{"__r":function($event){_vm.points=$event.target.value}}})]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.points))])]),_vm._v(" "),_c('div',[_c('header',[_vm._v("Rotate speed")]),_vm._v(" "),_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.rotateSpeed),expression:"rotateSpeed"}],attrs:{"id":"rotateSpeed","type":"range","min":"-1000","max":"1000"},domProps:{"value":(_vm.rotateSpeed)},on:{"__r":function($event){_vm.rotateSpeed=$event.target.value}}})]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.rotateSpeed))])])])])}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fb96d27e", __vue__options__)
  } else {
    hotAPI.reload("data-v-fb96d27e", __vue__options__)
  }
})()}
},{"./kaleidoscope.js":3,"vue":6,"vue-hot-reload-api":5}],3:[function(require,module,exports){
'use strict';
...
var Kaleidoscope = function () {
    function Kaleidoscope(canvasId, width, height, fullscreen, points, imagePath, rotateSpeed) {
        var _this = this;
    ...
    _createClass(Kaleidoscope, [{
        ...
        key: 'setupCanvas',
        value: function setupCanvas(callback) {
        ...
        key: 'setImage',
        value: function setImage(imagePath, callback) {
            var _this2 = this;
